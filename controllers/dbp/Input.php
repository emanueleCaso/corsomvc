...
use views\dbp\Input as InputView;
...
class Input extends Controller
{
    ...
    */
    protected function autorun($parameters = null)
    {
        ...
        $record->registerPkUrlParameter("input_id");
    ...
    protected function makeSearcher()
    {
        ...
        $view = new View("dbp/input_search_form");
        $searcher = new Searcher($view, $this->model);

        // Set component name
        $searcher->setName("ricerca_input");

        // Creates filters:
        // parameters: table field, form input, operators into query, data type
        $searcher->addFilter("input_id","input_id","=","string");
    ...
    {
        $parts = new  DataRepeater($this->view,$this->model,"Input",null);
        return $parts;
