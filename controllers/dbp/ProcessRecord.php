...
use models\dbp\ProcessRecord as ProcessRecordModel;
...
class ProcessRecord extends Controller
{
    protected $view;
    protected $model;
    ...
    protected function autorun($parameters = null)
    {
        ...
        $record->setName("ProcessRecord");
        $record->registerPkUrlParameter("process_id");
        ...
        $historyBack = $record->getControllerHistoryBack("processes");
    ...
    {
        $view = new ProcessRecordView("/dbp/process_record");
        return $view;
    }
