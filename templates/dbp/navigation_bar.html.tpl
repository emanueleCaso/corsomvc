...
<nav class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/corsomvc/dbp/">{RES:ProjectName}</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="/corsomvc/dbp/processes">Home</a></li>
                <li><a href="contacts">{RES:Contacts}</a></li>
                <li class="dropdown">
                ...
                <li><a href="/corsomvc/dbp/">{RES:Exit}</a></li>
            </ul>
        </div>
    </div>
</nav>
